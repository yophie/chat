package com.brother.myanmar.chat.listener;
...
public class ChatGroupListener extends AbstractImGroupListener {

	private  static Logger logger = LoggerFactory.getLogger(ChatGroupListener.class);
