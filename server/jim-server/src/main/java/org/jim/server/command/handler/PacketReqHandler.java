...
public class PacketReqHandler extends AbstractCmdHandler {

    @Override
    public ImPacket handler(ImPacket packet, ImChannelContext channelContext) throws ImException {
        if (packet.getBody() == null) {
            RespBody respBody = new RespBody(Command.COMMAND_PACKET_RESP, ImStatus.C10024);
    ...
    public Command command() {
        return Command.COMMAND_PACKET_REQ;
    }
}
